...
- TI – This variable indicates the gross total income of the individual filing the return

- tatus – This variable indicates the migration status of the return

- Year – This variable indicates the year in which the tax return was filed.
 
One anomaly we noticed while exploring the data is that the data collection is not consistent in the state of British Columbia. There were a few returns filed for certain age groups.
