...
g0 <- g0 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Under 26)") + labs(fill='AGI(USD in millions)')
g0
```
...
g1 <- g1 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Age 26-35)") + labs(fill='AGI(USD in millions)')
g1
```
...
g2 <- g2 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Age 35-45)") + labs(fill='AGI(USD in millions)')
g2
```
...
g3 <- g3 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Age 45-55)") + labs(fill='AGI(USD in millions)')
g3
```
...
g4 <- g4 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Age 55-65)") + labs(fill='AGI(USD in millions)')
...
g5 <- g5 + labs(x="Longitude", y="Latitude", title=" Avergae Gross Income vs  Region (Age 65+)") + labs(fill='AGI(USD in millions)')
